...
<head>
	...
	<title>Pathogen GeoTracker</title>
  ...
  <form class="navbar-form" role="search">
    <div class="input-group add-on">
      ...
      <div class="input-group-btn">
        <button class="btn btn-default" type="button" onclick="addr_search()";\><i class="fa fa-search"></i></button>
      </div>
    </div>
  </form>
...
L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
	...
	function onEachFeature(feature, layer) {
		var popupContent = "<p style=\"font-weight: bold;color:red;\">" + feature.properties.pathogenCommonName + " Pathogen Detected!" + "</p><p>Location: " + feature.properties.location + ", " + feature.properties.province + "</p><p>Coordinates: " + feature.geometry.coordinates[1] + ", " + feature.geometry.coordinates[0] + "</p>";
...
//function chooseAddr(lat1, long1, province){
    ...
    if(within_radius.length > 0){
        ...
        var popupContent = "<p style=\"font-weight: bold;color:red;\">" + within_radius[hdist_curr_index].properties.pathogenCommonName + " Pathogen Detected within " + hdist_max + " kms!" + "</p><p>Location: " + display_name + "</p><p>Coordinates: " + lat1.toFixed(4) + ", " + long1.toFixed(4) + "</p><p>Closest Location is " + within_radius[hdist_curr_index].hdist.toFixed(2) + " kms away in " + within_radius[hdist_curr_index].properties.location + ", " + within_radius[hdist_curr_index].properties.province + "</p>";
//         var popupContent = "<p style=\"font-weight: bold;color:red;\">" + within_radius[0].properties.pathogenCommonName + " Pathogen Detected!" + "</p><p>Location: " + province + "</p><p>Coordinates: " + lat1 + ", " + long1 + "</p>";
        if (within_radius[hdist_curr_index].properties && within_radius[hdist_curr_index].properties.popupContent) {
            popupContent += "<p>Description: " + within_radius[hdist_curr_index].properties.popupContent + "</p>";
        }
